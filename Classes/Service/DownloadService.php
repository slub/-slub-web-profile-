...
class DownloadService
{
     ...
     */
    public function getDownload(string $fileFormat): ?array
    {
        // Update the path for the api call for file format
        $this->apiConfiguration->updateDownloadPath($fileFormat);

        $uri = $this->apiConfiguration->getDownloadUri();
